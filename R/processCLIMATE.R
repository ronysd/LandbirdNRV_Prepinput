    ...
    fun = quote({
      ...
      names_b <- ifelse(
        grepl("^Normal_1991_2020_", names_b),
        {
          ...
          cleaned_name <- gsub("(Tave|PPT)_(wt|sm|sp|at)", "\\1\\2", cleaned_name)  # Remove underscores
          ifelse(grepl("_1km$", cleaned_name), cleaned_name, paste0(cleaned_name, "_1km"))  # Add _1km if needed
        },
